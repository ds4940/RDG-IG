...
export const Form: FC<FormProps> = ({ open, setOpen }) => {
  ...
  return (
    <>
      <Button variant="contained" color="secondary" onClick={handleClickOpen} data-testid="AddImage">
        Add Image
      </Button>
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          ...
          <Box display={"flex"} flexDirection={"column"}>
            ...
            <Box data-testid="Keywords" padding={"20px"}>
              <MultiInput values={value} setValues={setValue} />
            </Box>
            <Box data-testid="ImageDate" padding={"20px"}>
        ...
        <DialogActions>
          ...
          <Button type="submit" data-testid="SumbitImage" onClick={handleSubmit}>
            Submit
          </Button>
        </DialogActions>
      </Dialog>
